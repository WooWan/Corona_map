...
function AppLayOut({submit_patient,delete_patient,search,patients,location,children,update}) {
	...
	return (
		<div className="main">
			...
			<Corona_Map location={location} onSubmit={submit_patient} delete_patient={delete_patient} patients={patients} update_patient={update} />
			{children}
		</div>
